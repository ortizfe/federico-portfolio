...
import fares from "../assets/cropped-fares.png";
import { FARES } from "../components/resumes/resumes";
import ResumeLayout from "../components/resumes/ResumeLayout";
import FaresTechnologies from "../components/resumes/FaresTechnologies";
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center px-10 py-20 md:px-32">
      <div className="flex flex-col items-center justify-center gap-10">
        ...
        >
          <h1 className="text-4xl md:text-6xl">Fares Sahnouni</h1>
          <h3 className="text-md md:text-xl">
            IT Support Lead || Front-End Developer
          </h3>
          <div className="flex flex-wrap items-center justify-center gap-15 pt-5">
            <a
              href="https://github.com/fsahnouni"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/fares-sahnouni-236528205/"
              target="_blank"
              className="hover:scale-110 hover:cursor-pointer hover:text-indigo-300/80"
            >
              <FaLinkedin size={50} />
