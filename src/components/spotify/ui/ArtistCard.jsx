  ...
  return (
    <div>
      <section className="grid grid-cols-1 place-content-center p-2">
        <button
          onClick={openArtistInfo}
          className="group flex h-10 cursor-pointer items-center gap-5 rounded-full bg-neutral-200 pr-4 pl-3 text-black transition-all duration-300 ease-in-out hover:bg-black hover:pl-2 hover:font-bold hover:text-white active:bg-neutral-700"
        >
