...
const GradientSelectorButton = ({ text, onClick }) => {
  return (
    <div className="group relative w-[50px] transition-transform duration-300 active:scale-95">
      <button
        onClick={onClick}
        className="relative z-10 rounded-lg bg-gradient-to-br from-indigo-500 to-fuchsia-500 p-0.5 duration-300 group-hover:scale-110 hover:cursor-pointer"
      >
...
export default GradientSelectorButton;

GradientSelectorButton.propTypes = {
